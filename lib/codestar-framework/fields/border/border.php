  ...
  class CSF_Field_border extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      $args = wp_parse_args($this->field, array(
        ...
        'top_placeholder'    => esc_html__('top', 'adking-core'),
        'right_placeholder'  => esc_html__('right', 'adking-core'),
        'bottom_placeholder' => esc_html__('bottom', 'adking-core'),
        'left_placeholder'   => esc_html__('left', 'adking-core'),
        'all_placeholder'    => esc_html__('all', 'adking-core'),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__('Solid', 'adking-core'),
        'dashed'    => esc_html__('Dashed', 'adking-core'),
        'dotted'    => esc_html__('Dotted', 'adking-core'),
        'double'    => esc_html__('Double', 'adking-core'),
        'inset'     => esc_html__('Inset', 'adking-core'),
        'outset'    => esc_html__('Outset', 'adking-core'),
        'groove'    => esc_html__('Groove', 'adking-core'),
        'ridge'     => esc_html__('ridge', 'adking-core'),
