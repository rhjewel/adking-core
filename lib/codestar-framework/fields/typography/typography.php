  ...
  class CSF_Field_typography extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      if (! empty($args['font_family'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Family', 'adking-core') . '</div>';
        echo $this->create_select(array($this->value['font-family'] => $this->value['font-family']), 'font-family', esc_html__('Select a font', 'adking-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['backup_font_family'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Backup Font Family', 'adking-core') . '</div>';
        echo $this->create_select(apply_filters('csf_field_typography_backup_font_family', array(
          ...
          'Georgia, serif',
          'Palatino Linotype'
        )), 'backup-font-family', esc_html__('Default', 'adking-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_weight']) || ! empty($args['font_style'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Style', 'adking-core') . '</div>';
        echo '<select class="csf--font-style-select" data-placeholder="Default">';
        echo '<option value="">' . (! $this->chosen ? esc_html__('Default', 'adking-core') : '') . '</option>';
        ...
        if (! empty($args['extra_styles'])) {
          ...
          echo (! $this->chosen) ? '<div class="csf--title">' . esc_html__('Load Extra Styles', 'adking-core') . '</div>' : '';
          $placeholder = ($this->chosen) ? esc_html__('Load Extra Styles', 'adking-core') : esc_html__('Default', 'adking-core');
      ...
      if (! empty($args['subset'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Subset', 'adking-core') . '</div>';
        $subset = (is_array($this->value['subset'])) ? $this->value['subset'] : array_filter((array) $this->value['subset']);
        echo $this->create_select($subset, 'subset', esc_html__('Default', 'adking-core'), $args['multi_subset']);
        echo '</div>';
      }
      ...
      if (! empty($args['text_align'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Align', 'adking-core') . '</div>';
        echo $this->create_select(array(
          'inherit' => esc_html__('Inherit', 'adking-core'),
          'left'    => esc_html__('Left', 'adking-core'),
          'center'  => esc_html__('Center', 'adking-core'),
          'right'   => esc_html__('Right', 'adking-core'),
          'justify' => esc_html__('Justify', 'adking-core'),
          'initial' => esc_html__('Initial', 'adking-core')
        ), 'text-align', esc_html__('Default', 'adking-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_variant'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Font Variant', 'adking-core') . '</div>';
        echo $this->create_select(array(
          'normal'         => esc_html__('Normal', 'adking-core'),
          'small-caps'     => esc_html__('Small Caps', 'adking-core'),
          'all-small-caps' => esc_html__('All Small Caps', 'adking-core')
        ), 'font-variant', esc_html__('Default', 'adking-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['text_transform'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Transform', 'adking-core') . '</div>';
        echo $this->create_select(array(
          'none'       => esc_html__('None', 'adking-core'),
          'capitalize' => esc_html__('Capitalize', 'adking-core'),
          'uppercase'  => esc_html__('Uppercase', 'adking-core'),
          'lowercase'  => esc_html__('Lowercase', 'adking-core')
        ), 'text-transform', esc_html__('Default', 'adking-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['text_decoration'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Text Decoration', 'adking-core') . '</div>';
        echo $this->create_select(array(
          'none'               => esc_html__('None', 'adking-core'),
          'underline'          => esc_html__('Solid', 'adking-core'),
          'underline double'   => esc_html__('Double', 'adking-core'),
          'underline dotted'   => esc_html__('Dotted', 'adking-core'),
          'underline dashed'   => esc_html__('Dashed', 'adking-core'),
          'underline wavy'     => esc_html__('Wavy', 'adking-core'),
          'underline overline' => esc_html__('Overline', 'adking-core'),
          'line-through'       => esc_html__('Line-through', 'adking-core')
        ), 'text-decoration', esc_html__('Default', 'adking-core'));
        echo '</div>';
      }
      ...
      if (! empty($args['font_size'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Font Size', 'adking-core') . '</div>';
      ...
      if (! empty($args['line_height'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Line Height', 'adking-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['letter_spacing'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Letter Spacing', 'adking-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['word_spacing'])) {
        echo '<div class="csf--block">';
        echo '<div class="csf--title">' . esc_html__('Word Spacing', 'adking-core') . '</div>';
        echo '<div class="csf--input-wrap">';
      ...
      if (! empty($args['color'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Font Color', 'adking-core') . '</div>';
      ...
      if (! empty($args['custom_style'])) {
        ...
        echo '<div class="csf--title">' . esc_html__('Custom Style', 'adking-core') . '</div>';
    ...
    public function enqueue()
    {
      ...
      if (! wp_script_is('csf-webfontloader')) {
        ...
        wp_enqueue_script('csf-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', array('adking-core'), '1.6.28', true);
        ...
        if (! empty($customwebfonts)) {
          $webfonts['custom'] = array(
            'label' => esc_html__('Custom Web Fonts', 'adking-core'),
            'fonts' => $customwebfonts
          );
        }

        $webfonts['safe'] = array(
          'label' => esc_html__('Safe Web Fonts', 'adking-core'),
          'fonts' => apply_filters(
        ...
        $webfonts['google'] = array(
          'label' => esc_html__('Google Web Fonts', 'adking-core'),
          'fonts' => apply_filters(
        ...
        wp_localize_script('adking-core', 'csf_typography_json', array(
          'webfonts'      => $webfonts,
