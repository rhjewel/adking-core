...
if (! class_exists('CSF_Field_link_color')) {
  class CSF_Field_link_color extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      $color_props = array(
        'color'    => esc_html__('Normal', 'adking-core'),
        'hover'    => esc_html__('Hover', 'adking-core'),
        'active'   => esc_html__('Active', 'adking-core'),
        'visited'  => esc_html__('Visited', 'adking-core'),
        'focus'    => esc_html__('Focus', 'adking-core')
      );
