  ...
  class CSF_Field_media extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      $args = wp_parse_args($this->field, array(
        ...
        'preview_height' => '',
        'library'        => array(),
        'button_title'   => esc_html__('Upload', 'adking-core'),
        'remove_title'   => esc_html__('Remove', 'adking-core'),
      ...
      $placeholder = (empty($this->field['placeholder'])) ? ' placeholder="' .  esc_html__('Not selected', 'adking-core') . '"' : '';
