...
class Egns_Blog_Category_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            'egns_blog_category',
            __('Egns Blog Category', 'adking-core'),
            array(
                'description' => __('Displays blog categories with custom SVG icon', 'adking-core'),
            )
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (!empty($categories)) {
            ...
            echo '<p>' . esc_html__('No categories found.', 'adking-core') . '</p>';
        }
