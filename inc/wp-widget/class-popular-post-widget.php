...
class Egns_Popular_Post_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            'egns_popular_post',
            __('Egns Popular Post', 'adking-core'),
            array(
                'description' => __('Displays popular posts based on comment count', 'adking-core'),
            )
        );
    }
    ...
    {
        $title = isset($instance['title']) ? apply_filters('widget_title', $instance['title']) : 'Featured Article';
...
?>
    ...
    ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number_of_posts')); ?>"><?php echo esc_html__('Number of posts to show:', 'adking-core'); ?></label>
